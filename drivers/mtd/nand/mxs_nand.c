...
//static int mxs_nand_get_ecc_strength(struct mtd_info *mtd)
 int mxs_nand_get_ecc_strength(struct mtd_info *mtd)
{
	...
	if (chip->ecc_strength_ds > max_ecc_strength_supported) {
		...
		printf("chip->ecc_strength_ds = %d, max_ecc_strength_supported = %d\n", chip->ecc_strength_ds, max_ecc_strength_supported);
		return -EINVAL;
	}
